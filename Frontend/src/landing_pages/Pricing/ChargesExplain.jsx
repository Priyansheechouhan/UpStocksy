  ...
  return (
    <div className="container my-5">
      <div className="mx-5 px-5 py-5">
        ...
        <div className="row text-muted">
          <div className="col-lg-6 pe-4">
            ...
            <div>
                ...
                <p className="charges-para">Additional charges of ₹50 per order for orders placed through a dealer at Zerodha including auto square off orders.</p>
            </div>
            <div>
                <h6 className="mb-4">Stamp charges</h6>
                <p className="charges-para">Stamp charges by the Government of India as per the Indian Stamp Act of 1899 for transacting in instruments on the stock exchanges and depositories.</p>
            </div>
            <div>
                <h6 className="mb-4">NRI brokerage charges</h6>
                <ul className="charges-para ps-4">
            ...
            <div>
                ...
                <p className="charges-para">If the account is in debit balance, any order placed will be charged ₹40 per executed order instead of ₹20 per executed order.</p>
            </div>
            <div>
                <h6 className="mb-4">Charges for Investor's Protection Fund Trust (IPFT) by NSE</h6>
                <ul className="charges-para ps-4">
          ...
          <div className="col-lg-6">
            ...
            <div>
                ...
                <p className="charges-para">₹15.34 per scrip (₹3.5 CDSL fee + ₹9.5 Zerodha fee + ₹2.34 GST) is charged on the trading account ledger when stocks are sold, irrespective of quantity.</p>
                <p className="charges-para">Female demat account holders (as first holder) will enjoy a discount of ₹0.25 per transaction on the CDSL fee.</p>
                <p className="charges-para">Debit transactions of mutual funds & bonds get an additional discount of ₹0.25 on the CDSL fee.</p>
            </div>
            <div>
                <h6 className="mb-4">Pledging charges</h6>
                <p className="charges-para">₹30 + GST per pledge request per ISIN.</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p className="charges-para">₹20 plus GST will be charged for OFS / buyback / takeover / delisting orders placed through Console.</p>
            </div>
            <div>
            ...
            <div>
                <h6 className="mb-4">Trading using 3-in-1 account with block functionality</h6>
                <ul className="charges-para ps-4">
        ...
        <div className="row mt-4 text-muted pe-3">
